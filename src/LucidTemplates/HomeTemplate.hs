            ...
            div_ [ class_ "col-sm-10" ] $ do
              ...
              div_ [ class_ "wedding-details margin-bottom" ] $ do
                div_ [ class_ "w-detail right" ] $ do
                  ...
                  a_ [ href_ "https://meet.google.com/mik-jsvm-yxv", target_ "_blank"  ] $ p_ [] $ "Da click aquí para unirte virtualmente (Sala 1)"
                  a_ [ href_ "https://meet.google.com/jtp-rpdi-jbc", target_ "_blank"  ] $ p_ [] $ "Da click aquí para unirte virtualmente (Sala 2)"
                toHtmlRaw  "<!-- w-detail -->"
