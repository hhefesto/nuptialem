            ...
            div_ [ class_ "col-sm-10" ] $ do
              ...
              div_ [ class_ "wedding-details margin-bottom" ] $ do
                div_ [ class_ "w-detail right" ] $ do
                  ...
                  p_ "Acompáñanos en Santa Rosa de Viterbo."
                  a_ [ href_ "/" ] $ p_ [] $ "Link virtual."
                toHtmlRaw  "<!-- w-detail -->"
                div_ [ class_ "w-detail left" ] $ do
                  i_ [ class_ "icon icon-wine-glass" ] $ ""
                  h4_ [ class_ "title" ] $ "18:30 - 19:30 Coctel de Bienvenida"
                  p_ "Acompáñanos en la casa de los papás/suegros Alberto y Gemma (link a dirección)."
                  a_ [ href_ "/" ] $ p_ "Link virtual."
                toHtmlRaw  "<!-- w-detail -->"
                div_ [ class_ "w-detail right" ] $ do
                  i_ [ class_ "icon icon-heart" ] $ ""
          ...
          div_ [ class_ "row" ] $ do
            div_ [ class_ "col-sm-12" ] $ do
              ...
              div_ [ class_ "ceremony margin-bottom" ] $ do
                p_ [ class_ "desc" ] $ "El 21 de noviembre en esta sección de la página web podrás encontrar los links para acompañarnos vía Zoom o Google Meet."
